...
Original file is located at
    https://colab.research.google.com/drive/1XVFvquxkbzA8OjBPiXIpn9ZAbYVC5jzs
"""
...
def main():
    ...
    if st.button("Predict"):
        oxygen_val = float(oxygen)
        humidity_val = float(humidity)
        temperature_val = float(temperature)
        output=predict_forest(oxygen_val,humidity_val,temperature_val)
